...
The cluster ladder is organised by **thematic cluster (A-L, skipping K)**, not by T-number order. Tail extensions (notebooks added out of cluster order without renumbering, e.g. T73 in cluster A, T78 in cluster E) sit at the RIGHT end of their target cluster's tile row.
